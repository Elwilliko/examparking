...
$sql = "SELECT u.usu_cedula, u.usu_nombres, u.usu_direccion, u.usu_telefono, v.vei_placa, v.vei_marca, v.vei_modelo, t.tik_numero, t.tik_fecha_ingreso, t.tik_hora_ing, t.tik_fecha_salida, t.tik_hora_sal
 ...
 AND v.vei_codigo = t.tik_vei_codigo 
 AND usu_cedula = '$cedula'";

$sql1 = "SELECT u.usu_cedula, u.usu_nombres, u.usu_direccion, u.usu_telefono, v.vei_placa, v.vei_marca, v.vei_modelo, t.tik_numero, t.tik_fecha_ingreso, t.tik_hora_ing, t.tik_fecha_salida, t.tik_hora_sal
 FROM usuario u, vehiculo v, ticket t 
 WHERE u.usu_codigo = v.vei_usu_codigo
 AND v.vei_codigo = t.tik_vei_codigo 
 AND vei_placa = '$placa'";
